...
commands = {
    ...
    "farewell": ["пока", "свидания", "прощай", "бай"] ,
    "grant": ["грант", "заявка", "заявку", "заявке", "заявки", "подать"],
    "project": ["создать", "проект", "проекта", "проекты", "проектов", "добавить"],
    "faq": ["проблема", "проблемы", "технические", "техническая", "вопрос", "вопросы", "вопросов", "вопросах", "трудность", "трудности"],
    "agreement": ["да", "ага", "конечно"],
    "disagreement": ["нет", "неа"],
    "help": ["помощь"],
    "exit": ["звершить", "окончить", "закончить", "остановить", "остановись", "заверши", "окончи", ],
    "thanking" : ["спасибо"],
    "unknown" : []
}
            ...
            for i in range(len(command)):
                if command[i] in commands[key]:
                    ...
                    if key == "greeting":
                        ...
                        play_voice_assistant_speech("Услышимся")
                        exit()

                    elif key == "thanking":
                        play_voice_assistant_speech("всегда пожалуйста")
                        break

                    else:
                        play_voice_assistant_speech("Извините, я не могу пока что вас понять")
                        break
